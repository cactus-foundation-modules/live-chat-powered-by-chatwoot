  ...
  return (
    <>
      ...
      {!panelOpen && info.hideLabelOnMobile && (
        ...
        // the speech bubble alone still reads as chat. Desktop keeps the words.
        // !important because the bubble's own padding is an inline style, which
      ...
      {!panelOpen && (
        ...
        >
          ...
          <span className={info.hideLabelOnMobile ? 'lc-bubble-text' : undefined}>
